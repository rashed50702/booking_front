                ...
                <div class="search-box">
                  <v-form @submit.prevent="search">
                    <v-row>
                      <v-col cols="12" sm="5">
                        <p>From:</p>
                        <VueDatePicker v-model="form.start_time" :min-date="new Date()" :month-change-on-scroll="false"/>
                      </v-col>
                      <v-col cols="12" sm="5">
                        <p>To:</p>
...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            let timediff = Math.floor(((this.form.start_time - this.form.end_time) / 1000) /60 );
            if (timediff > -30) {
